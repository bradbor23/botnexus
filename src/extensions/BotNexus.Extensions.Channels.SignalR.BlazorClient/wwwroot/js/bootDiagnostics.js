...
// start promise with nothing attached. The static `.boot-skeleton` div in index.html is never
...
(function () {
    ...
    function renderPanel(kind, message) {
        ...
        // Replacing #app wholesale is what removes the static .boot-skeleton. Leaving the placeholders
