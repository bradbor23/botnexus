...
public sealed class GatewayEventHandlerTests
{
    ...
    {
        _handler = new GatewayEventHandler(_store, OfflineTestHub.Create(), Microsoft.Extensions.Logging.Abstractions.NullLogger<GatewayEventHandler>.Instance, _store);
