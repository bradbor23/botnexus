...
public sealed class InterruptAndSteerTests
{
    ...
    {
        _service = new AgentInteractionService(_store, OfflineTestHub.Create(), _restClient, Microsoft.Extensions.Logging.Abstractions.NullLogger<AgentInteractionService>.Instance);
