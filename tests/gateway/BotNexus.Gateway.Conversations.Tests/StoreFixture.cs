...
internal sealed class StoreFixture : IDisposable
{
    ...
    public SqliteConversationStore CreateStore(TimeProvider clock)
        => new(ConnectionString, NullLogger<SqliteConversationStore>.Instance, worldContext: null, clock: clock);
